...
To use the plugin, run ```hyprctl dispatch swapwindowv2 address:0x12345678,address:0x12345678```, replacing the addresses with the address you want to target, future support for other regexes will be added, currently only addresses are supported and process ids are supported, using any other regex will produce unintended results
